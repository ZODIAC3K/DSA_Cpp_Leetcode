...
#         # windows size is contant k
#         # if window size is even return 0 
#         # if middle is odd then median is middle two element sum / 2
#         l = 0
#         r = k-1
#         median = []
...
#             subarr.sort()
#             if k % 2 != 0:
#                 curr_median = subarr[len(subarr)//2]
#                 median.append(curr_median)
#             else:
#                 curr_median = (subarr[len(subarr)//2] + subarr[ len(subarr)//2 - 1]) / 2
#                 median.append(curr_median)
#             l += 1
#             r += 1
